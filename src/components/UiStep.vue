...
<template>
    <div class="bg-indigo-300/10 rounded px-4 py-2 flex space-x-4">
        <div class="flex items-center justify-center text-gray-200">
            <!-- Pending. -->
            <svg v-if="step.status === 'pending'" class="h-7 w-7" xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256">
            ...
            <!-- Running. -->
            <svg v-else-if="step.status === 'running'" class="animate-spin h-7 w-7" xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256">
                <rect width="256" height="256" fill="none"></rect>
            ...
            <!-- Successful. -->
            <svg v-else-if="step.status === 'successful'" class="h-7 w-7 text-emerald-400" xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256">
                <rect width="256" height="256" fill="none"></rect>
            ...
            <!-- Failed. -->
            <svg v-else-if="step.status === 'failed'" class="h-7 w-7 text-red-400" xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256">
                <rect width="256" height="256" fill="none"></rect>
                <circle cx="128" cy="128" r="96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></circle>
        ...
        <div>
            <div v-text="step.name"></div>
            <div v-text="step.status" class="text-sm text-indigo-300/60"></div>
        </div>
    </div>
</template>
